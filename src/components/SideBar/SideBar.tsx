...
import { ReactComponent as ChatImg } from '../../images/sideBar/chat.svg'
...
export const SideBar: React.FC<PropsType> = (props) => {
  ...
  return (
    <div className={classes.sideBar} id={classes.pageSideBar}>
      {isAuth ? (
        <div className={classes.item}>
          <NavLink to="/profile">
            <img
              className={cn(classes.img, classes.auth_user)}
              src={userPhoto}
              alt=""
            />{' '}
            <h3>{login}</h3>
      ...
      <div className={classes.item}>
        <NavLink to="/messages">
          <MessangerImg className={classes.img} />
          <h3>Messages</h3>
        </NavLink>
      </div>
      <div className={classes.item}>
        <NavLink to="/videos">
          <VideoImg className={classes.img} />
          <h3>Videos</h3>
        </NavLink>
      </div>
      <div className={classes.item}>
        <NavLink to="/chat">
          <ChatImg className={classes.img} />
          <h3>Chat</h3>
        </NavLink>
      </div>
    </div>
