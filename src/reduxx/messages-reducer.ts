...
const messagesReducer = (state = initialState, action: MessagesReducerActionsTypes): InitialStateType => {
...
// Action Creators
type MessagesReducerActionsTypes = InferActionsTypes<typeof actionsMessagesReducer>
